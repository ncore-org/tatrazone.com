...
export default function CookieConsent() {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-50 transition-transform duration-250 ease-out ${
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <svg className="w-5 h-5 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
              ...
              <div
                className={`overflow-hidden transition-all duration-200 ease-in-out ${
                  showDetails ? "max-h-[300px] opacity-100 mt-3" : "max-h-0 opacity-0"
                }`}
              >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto shrink-0">
              <button
                ...
                className="text-xs text-gray-500 hover:text-gray-700 underline underline-offset-2 whitespace-nowrap px-3 py-1.5 transition-colors"
              >
