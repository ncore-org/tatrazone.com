    ...
    <div className="bg-white rounded-xl border border-gray-200 p-4 md:p-6">
      ...
      {items.length === 0 ? (
        ...
        <>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-green-800 font-bold">
                  {(200 - subtotal).toLocaleString("pl-PL", {
                    style: "currency",
                    currency: "PLN",
                  })}
                </span>
          ...
          <Link
            href="/kasa"
            className="block w-full bg-blue-600 text-white font-bold text-center py-3 rounded-xl hover:bg-blue-700 transition-colors mt-4"
          >
            Przejdź do kasy
          </Link>
        </>
